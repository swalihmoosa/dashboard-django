...
from product.views import category, add_new_product, add_product_form, productitem, edit_product, update, delete_product, delete_category, Product_view
...
urlpatterns = [
    ...
    path('delete_multiple/',Product_view.as_view(),name='delete_multiple')
]